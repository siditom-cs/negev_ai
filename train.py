...
if __name__ == '__main__':
    ...
    #training_generator = DataGenerator(batch_size=2, augmentations=AUGMENTATIONS_TRAIN,img_size=128, train_im_path=train_im_path,train_mask_path=train_mask_path)
    ...
    #validation_generator = CombinedDataGenerator(batch_size=2, augmentations=None,img_size=256, train_im_path=train_im_path,train_mask_path=train_mask_path) #TODO change the paths at runtime.
